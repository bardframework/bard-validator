 ...
 */
public class PastEpochDateTimeValidator extends SingleFieldValidatorAbstract<Long> {

    public PastEpochDateTimeValidator() {
        super("before_date_time.error");
    }

    public PastEpochDateTimeValidator(String errorCode) {
        super(errorCode);
    }
