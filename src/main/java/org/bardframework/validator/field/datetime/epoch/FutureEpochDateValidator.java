 ...
 */
public class FutureEpochDateValidator extends SingleFieldValidatorAbstract<Long> {

    public FutureEpochDateValidator() {
        super("must_after_today_date");
    }

    public FutureEpochDateValidator(String errorCode) {
        super(errorCode);
    }
